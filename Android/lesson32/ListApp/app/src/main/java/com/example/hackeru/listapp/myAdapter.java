...
public class myAdapter extends ArrayAdapter<Integer>{
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        viewsContainer.upperItemLbl.setText(""+position+position+position+position+position);
        viewsContainer.lowerItemLbl.setText(""+position+position+position+position+position);
