...
class AppDelegate: UIResponder, UIApplicationDelegate {
	...
	func addPerson(firstName: String, lastName: String, age: Int){
		...
		person.firstName = firstName //person.setValue(firstName, forKey: "firstName")
		person.lastName = lastName
		person.age = Int16(age)
		saveContext()
	}
	
	func editPerson(_ person: Person, firstName: String, lastName: String, age: Int){
	...
	func fetchPeople() -> [Person]{
		...
		let personObjects: [Person] = try! context.fetch(Person.fetchRequest())
