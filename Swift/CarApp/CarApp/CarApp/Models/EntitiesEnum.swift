...
//	case entity(Entity.EntityProperty)
//	case car(Car.CarProperty)
//	case refuel(Refuel.RefuelProperty)
//	case service(Service.ServiceProperty)
//	case expense(Expense.ExpenseProperty)
//	case serviceType(ServiceType.ServiceTypeProperty)
//	case garage(Garage.GarageProperty)
//
//	func isType<T: Entity>(of type: T.Type) -> Bool{
//		switch self{
//		case .entity(_):
//			return true
//		case .car(_):
//			return type == Car.self
//		case .refuel(_):
//			return type == Refuel.self
//		case .service(_):
//			return type == Service.self
//		case .expense(_):
//			return type == Expense.self
//		case .serviceType(_):
//			return type == ServiceType.self
//		case .garage(_):
//			return type == Garage.self
//		}
//	}
